...
public static class Modifiers
{
    ...
    public static readonly Dictionary<TerrainType, int> MovementCosts = new()
    {
        { TerrainType.Flat, 1 },
    ...
    public static readonly Dictionary<TerrainType, float> Defenses = new()
    {
