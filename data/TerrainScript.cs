...
//		Water deep
		...
		AddCliffGraphic("Gg", "assets/graphics/models/cliff_test.tres");
		AddCliffGraphic("Gll", "assets/graphics/models/cliff_test.tres");
		AddCliffGraphic("Ms", "assets/graphics/models/cliff_test.tres");
		AddCliffGraphic("Rd", "assets/graphics/models/cliff_test.tres");
		AddCliffGraphic("Sd", "assets/graphics/models/cliff_test.tres");
		AddCliffGraphic("Sm", "assets/graphics/models/cliff_test.tres");
		AddCliffGraphic("Sb", "assets/graphics/models/cliff_test.tres");
		AddCliffGraphic("Ch", "assets/graphics/models/cliff_test.tres");
		AddCliffGraphic("Kh", "assets/graphics/models/cliff_test.tres");
